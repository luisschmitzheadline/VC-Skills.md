...
| Pitch Deck Skill | Create and review pitch decks with frameworks for narrative structure, slide con... | fundraising_support, document_generation | No |
| Presentation Quality Checker Skill | Performs comprehensive QC on presentations checking number consistency, data-nar... | document_generation, lp_reporting | Yes |
...
| Name | Description | Tasks | Official |
|------|-------------|-------|----------|
| BoldSign MCP Server | Search, request, and manage e-signature contracts. | document_generation | Yes |
...
| Courier MCP Server | Build and send multi-channel notifications across email, SMS, push, Slack, and T... | lp_communication, communication_management | Yes |
...
| Customer.io MCP Server | Work with Customer.io workspace for segments, user profiles, and targeted commun... | lp_communication, communication_management | Yes |
